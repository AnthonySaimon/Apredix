...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='1main.css'>
...
<body>
    ...
    <nav class="user">
        ...
        if (isset($_GET['erro'])) {
            $erro = $_GET['erro'];
            if ($erro == 1) {
                echo  '<div class="C"> <h3>Foi Atualizado com sucesso</h3> <a href="./index.php"> <ion-icon name="close-sharp"></ion-icon></a></div>';
            } elseif ($erro == 2) {
                echo '<div class="E"> <h3>Erro ao Inserir</h3> <a href="./index.php"> <ion-icon name="close-sharp"></ion-icon></a></div>';
            } elseif ($erro == 3) {
                echo  '<div class="C"> <h3>Foi Excluido com sucesso</h3> <a href="./index.php"> <ion-icon name="close-sharp"></ion-icon></a></div>';
            } elseif ($erro == 4) {
                echo  '<div class="E"> <h3>Erro com ID do usuario</h3> <a href="./index.php"> <ion-icon name="close-sharp"></ion-icon></a></div>';
            } elseif ($erro == 5) {
                echo  '<div class="C"> <h3>Foi Banir com sucesso</h3> <a href="./index.php"> <ion-icon name="close-sharp"></ion-icon></a></div>';
            } elseif ($erro == 6) {
                echo  '<div class="E"> <h3>Erro ou banir o usuario</h3> <a href="./index.php"> <ion-icon name="close-sharp"></ion-icon></a></div>';
            }
        }
        ?>
        ...
        <?php foreach ($manager->list_client() as $data) : ?>
            <div class="elemuser">
                ...
                <div class="aba2">
                    ...
                    <form method="POST" action="../Gerenciar_user_dlt/index.php">
                        <input type="hidden" name="id" value=<?= $data['id'] ?>>
                    ...
                    <form method="POST" action="../Gerenciar_ban/index.php">
                        <input type="hidden" name="id" value=<?= $data['id'] ?>>
